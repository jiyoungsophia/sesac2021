...
* #### 다른 Tab에서 Root Tab으로 이동할 때

  ```
  1. Root Tab: WillAppear //
  2. 이전 Tab: WillDisappear //
  3. 이전 Tab: DidDisappear
  4. Root Tab: DidAppear
  ```
...
* #### Tabbar vs. Navigation(Push)

|           | Tabbar                                        | Navigation(Push)                                |
| --------- | --------------------------------------------- | ----------------------------------------------- |
| 이동할 때 | - 이전 탭 willDisappear <br>- 현재 탭 didLoad | - 현재 Push didLoad<br>- 이전 뷰 willDisappear  |
| 돌아올 때 | - Root willAppear<br/>- 이전 탭 willDisappear | - 이전 Push willDisappear<br/>- Root willAppear |
